package aptech.fatima.map.network;

import aptech.fatima.map.models.ModelHome;
import aptech.fatima.map.models.ModelPlaylist;
...
public class YoutubeAPI {
   ...
   // public static final String CHANNEL_ID = "UCkXmLjEr95LVtGuIm3l2dPg";
    public static final String KEY = "key=AIzaSyAjbS-AJwdUslo_zD_gdw4q0-VdGFsjjW4";
